...
export default function ModeratorDashboard() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'overview':
        return <ModeratorOverviewTab />;
      case 'leaderboard':
        return <ModeratorLeaderboardTab />;
      case 'competitions':
        return <ModeratorCompetitionsTab />;
      case 'questions':
        return <ModeratorQuestionsTab />;
      case 'messages':
        return <MessagesTab />;
      case 'settings':
        return <ModeratorSettingsTab />;
      default:
        return <ModeratorOverviewTab />;
    }
  };
...
function ModeratorCompetitionsTab() {
  const [competitions, setCompetitions] = useState([]);
  const [loading, setLoading] = useState(false);
...
function ModeratorQuestionsTab() {
      ...
      <div>
        ...
        {isAdminOrModerator && currentView && (
          <div className="mt-2 flex items-center gap-2 text-sm text-primary">
            ...
            <span>Viewing as Moderator - Can see messages from all users</span>
          </div>
        )}
      </div>
