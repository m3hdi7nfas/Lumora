      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div classNameI see the issue. The error indicates that `showAds` is not defined in the `AdminDashboard.tsx` file. Let me check the code and fix this issue. The problem is likely that the `showAds` state variable is not being properly passed to the component that needs it.

<dyad-write path="src/components/dashboards/AdminDashboard.tsx" description="Fixing showAds undefined error in AdminDashboard">
import { useState, useEffect } from 'react';
import { DashboardLayout } from './DashboardLayout';
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
