      ...
      <div>
        ...
        {isAdminOrModerator && currentView && (
          <div className="mt-2 flex items-center gap-2 text-sm text-primary">
            ...
            <span>Admin View - Full platform access</span>
          </div>
        )}
      </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage user avatars and unlock conditions</p>
        </div>
      ...
      <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Upload a new avatar image and set unlock conditions</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={newAvatar.unlock_condition}
                onValueChange={(value) => setNewAvatar({ ...newAvatar, unlock_condition: value })}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select unlock condition" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">No unlock required</SelectItem>
                  <SelectItem value="questions_answered">Answer questions</SelectItem>
                  <SelectItem value="login_streak">Login streak</SelectItem>
                  <SelectItem value="score">Reach score</SelectItem>
                  <SelectItem value="competitions_won">Win competitions</SelectItem>
                </SelectContent>
              </Select>
            </div>
            {newAvatar.unlock_condition !== 'none' && (
              <div className="space-y-2">
                <Label>Unlock Value</Label>
                <Input
                  type="number"
                  value={newAvatar.unlock_value}
                  onChange={(e) => setNewAvatar({ ...newAvatar, unlock_value: parseInt(e.target.value) || 0 })}
                  placeholder="e.g., 50"
                />
                <p className="text-xs text-muted-foreground">
                  {newAvatar.unlock_condition === 'questions_answered' && 'Number of questions to answer'}
                  {newAvatar.unlock_condition === 'login_streak' && 'Number of consecutive logins'}
                  {newAvatar.unlock_condition === 'score' && 'Score points required'}
                  {newAvatar.unlock_condition === 'competitions_won' && 'Competitions to win'}
                </p>
              </div>
            )}
          </div>
